...
const getErrorMessage = (obj: any, keys: any[]) =>
  keys.reduce(
    (obj: { [x: string]: any }, key: string | number) =>
      typeof obj == "object" ? obj[key] : undefined,
    obj
  );
...
export function convertDateToArray(inputDate: string): (number | string)[] {
  function convertToAMPM(hour24String: string): string {
